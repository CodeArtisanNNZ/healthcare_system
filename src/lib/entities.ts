...
export const entities: Record<string, Entity> = {
  ...
  caregivers: {
    ...
    fields: [
      f("full_name", "Full name", "text", true),
      f("gender", "Gender", "select", true, ["Female", "Male", "Other"]),
      f("experience", "Experience (years)", "number"),
      f("qualification", "Qualification"),
      ...
      f("location", "Service area / location", "text", true),
      f("fee_per_day", "Daily fee (BDT)", "number"),
      f("languages", "Languages"),
      f("phone", "Private phone"),
      f("email", "Private email", "email"),
      f("source_or_agency", "Agency / source"),
      f("verification_status", "Verification status", "select", true, ["Needs review", "Verified"]),
