...
export default async function CaregiverRequestPage() {
  ...
  return (
    <div className="container section">
      ...
      <Heading eyebrow="HOME CARE REQUEST" title="Tell us what kind of care is needed">
        Share the practical details and Healthcare Central will review suitable
        caregivers or provider organizations.
      </Heading>
      ...
      <div className="card">
        ...
        >
          ...
          <p className="muted">
            ...
            compare care needs, gender preference, area, shift, availability and
            budget before confirming a caregiver or provider.
          </p>
        </ActionForm>
      </div>
